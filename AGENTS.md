...
- **AI/Internal Tools**: Hermes, Gas City (`gascity.internal`, fallback `192.168.0.203`, internal dashboard mutations enabled), Paperclip (`paperclip.internal`), LiteLLM, Langfuse, Open WebUI, AWTRIX MQTT
